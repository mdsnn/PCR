import { Bell, Home, Map, MapPin, MessageCircle, Minus, Plus, Search, ShoppingCart, Trash2 } from 'lucide-react';
                ...
                <main className="flex-1 p-4 lg:border-r lg:border-gray-200/60">
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <h2 className="text-3xl font-bold text-gray-900">My Basket</h2>
                            <span className="rounded-full bg-green-100 px-4 py-2 text-sm font-medium text-green-700">5 items</span>
                        </div>
