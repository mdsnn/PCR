...
// Custom clustering component using native Leaflet
function ClusterLayer({ markers, category, onMarkerClick }: {
    markers: MarkerData[];
    category: Category;
    ...
    useEffect(() => {
        ...
        if (typeof (L as any).MarkerClusterGroup === 'undefined') {
            console.warn('Leaflet MarkerCluster not loaded. Add the CDN links to your HTML.');
            return;
        }
        ...
        <div className="fixed inset-0 z-50 bg-white md:hidden">
            ...
            <div className="border-b bg-gray-50 p-4">
                <input
                    ...
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[var(--my-green)] focus:outline-none focus:ring-1 focus:ring-[var(--my-green)]"
                />
            </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="flex flex-col items-center">
                                    <div 
                                        className="h-6 w-6 rounded-full border-2 border-white shadow-md flex items-center justify-center text-white text-xs font-bold"
            ...
            <div className="border-t bg-white p-4">
                <div className="flex gap-2">
                    <button 
                        onClick={onClose}
                        className="flex-1 rounded-lg bg-[var(--my-green)] px-4 py-3 text-sm font-medium text-white"
                    >
                        Back to Map
                    </button>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex">
                        <input
                            ...
                            className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[var(--my-green)] focus:outline-none focus:ring-1 focus:ring-[var(--my-green)]"
                        />
                    </div>
                    ...
                    <div className="flex gap-2 md:hidden">
                        <button
                            ...
                            className="rounded-lg bg-[var(--my-green)] p-2 text-white"
                            title="List view"
                        >
                            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            className="rounded-lg border border-gray-300 bg-white p-2 text-gray-600"
                            title="Search"
                        >
                            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1 relative">
                    ...
                    <div className="absolute top-4 left-4 z-10 bg-white rounded-lg shadow-md p-2">
                        <div className="text-xs text-gray-600">
                            Zoom to see individual markers
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white border-t shadow-lg">
                    <div className="p-4">
                        ...
                        <div className="mt-3 flex gap-2">
                            <button className="flex-1 rounded-lg bg-[var(--my-green)] px-3 py-2 text-sm font-medium text-white">
                                Directions
                            </button>
